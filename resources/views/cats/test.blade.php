...
<div id="controls">
    <strong>Inbreeding:</strong>
        ...
        <input type="checkbox" name="same_breed"><label for="same_breed">{{ __('cat.same_breed') }}</label>
</div>
<div id="set">
    <div class="sire">
                    ...
                    <td class="anc">
                        ...
                        <table data-level="1">
                            ...
                            <tbody>
                                ...
                                @php $json .= "\"s\": {" @endphp
                                <tr class="s">
                                    <td> Sire:<br><input class="ind" id="s" type="text" data="{{$cat->id()}}" disabled><br>{{$cat->l($generations)}}<br>{{ $cat->breed }} {{ $cat->ems_color }} {{ $cat->dob() }}<br>
