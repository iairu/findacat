...
@else
    <div class="pull-right">
        {{ link_to_route('cats.show', __('app.show_profile').' '.$cat->name, [$cat->id], ['class' => 'btn btn-default']) }}
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row">
                ...
                {{ Form::close() }}
                <div class="col-md-6">
                    @includeWhen(request('tab') == null || !in_array(request('tab'), $validTabs), 'cats.partials.update_photo')
